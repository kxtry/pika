...
class BlackWidow {
 public:
  ...
  Status SetOnce(const Slice& key, const Slice& value);
  ...
  Status Incrbyrange(const Slice& key, int64_t value, int64_t* ret, int64_t min_, int64_t max_);
  ...
  Status HSet(const Slice& key, const Slice& field, const Slice& value,
              int32_t* res);
  Status HSetOnce(const Slice& key, const Slice& field, const Slice& value,
              int32_t* res);
  ...
  Status HIncrbyrange(const Slice& key, const Slice& field, int64_t value, int64_t* ret, int64_t min_, int64_t max_);
