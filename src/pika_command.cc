...
void InitCmdTable(std::unordered_map<std::string, Cmd*> *cmd_table) {
  ...
  ////SetOnceCmd
  Cmd* setonceptr = new SetOnceCmd(kCmdNameSetOnce, -3, kCmdFlagsWrite | kCmdFlagsSinglePartition | kCmdFlagsKv);
  cmd_table->insert(std::pair<std::string, Cmd*>(kCmdNameSetOnce, setonceptr));
  ////GetCmd
  ...
  ////IncrbyrangeCmd
  Cmd* incrbyrangeptr = new IncrbyrangeCmd(kCmdNameIncrbyrange, 5, kCmdFlagsWrite | kCmdFlagsSinglePartition | kCmdFlagsKv);
  cmd_table->insert(std::pair<std::string, Cmd*>(kCmdNameIncrbyrange, incrbyrangeptr));
  ////IncrbyfloatCmd
  ...
  ////HSetOnceCmd
  Cmd* hsetonceptr = new HSetOnceCmd(kCmdNameHSetOnce, 4, kCmdFlagsWrite | kCmdFlagsSinglePartition | kCmdFlagsHash);
  cmd_table->insert(std::pair<std::string, Cmd*>(kCmdNameHSetOnce, hsetonceptr));
  ////HGetCmd
  ...
  ////HIncrbyrangeCmd
  Cmd* hincrbyrangeptr = new HIncrbyrangeCmd(kCmdNameHIncrbyrange, 6, kCmdFlagsWrite |kCmdFlagsSinglePartition | kCmdFlagsHash);
  cmd_table->insert(std::pair<std::string, Cmd*>(kCmdNameHIncrbyrange, hincrbyrangeptr));
  ////HIncrbyfloatCmd
